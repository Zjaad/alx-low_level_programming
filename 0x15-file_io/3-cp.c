 ...
 * Return: 0 on success.
 *
 * Description: Exits with different error codes based on specific conditions.
 *              Exit code 97 if the argument count is incorrect.
 *              Exit code 98 if the source file cannot be read.
 *              Exit code 99 if the destination file cannot be created or written to.
 *              Exit code 100 if any file cannot be closed.
 */
